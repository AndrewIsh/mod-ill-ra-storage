...
CREATE TABLE schema_name.ill_status (_id SERIAL PRIMARY KEY, jsonb JSONB NOT NULL);
GRANT ALL ON schema_name.ill_status TO user_name;
GRANT ALL ON schema_name.ill_status__id_seq TO user_name;
